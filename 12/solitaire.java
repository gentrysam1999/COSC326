...
public class solitaire{
   ...
   public static void main(String[] args){
      ...
      pegJumpAndCheck(numPegs, pegArray);
   }
    ...
    */
   public static void pegJumpAndCheck(int numPegs, int[] pegArray){
      ...
      for(int i = 2; i < pegArray.length-2; i++){
         if(pegArray[i] == 1){
            ...
            if(pegArray[i-1] == 0 && pegArray[i-2] == 0){
               ...
               pegJumpAndCheck((numPegs + 1), pegJumpLeft(i, PegArrayOne));
            }
            
            if(pegArray[i+1] == 0 && pegArray[i+2] == 0){
               int[] PegArrayTwo = Arrays.copyOf(pegArray, pegArray.length);
               pegJumpAndCheck((numPegs + 1), pegJumpRight(i, PegArrayTwo));
            }
         }
      }
      return;
